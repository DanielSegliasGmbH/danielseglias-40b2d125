        ...
        <BrowserRouter>
          ...
          <AuthProvider>
            ...
            <Routes>
              ...
              />
              <Route
                path="/app/client-portal/finanz-typ"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
              ...
              <Route
                ...
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalManifest />
                  </RouteGuard>
                }
              />
              <Route
                path="/app/client-portal/life-film"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalLifeFilm />
                  </RouteGuard>
                }
              />
              <Route
                path="/app/client-portal/life-film-result"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalLifeFilmResult />
                  </RouteGuard>
                }
              />
              <Route
              ...
              />
              <Route
                path="/app/client-portal/partner"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalPartner />
                  </RouteGuard>
              ...
              />
              <Route
                path="/app/client-portal/last-plan"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalLastPlan />
                  </RouteGuard>
                }
              />
              <Route
                path="/app/client-portal/expat"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalExpat />
                  </RouteGuard>
              ...
              />
              <Route
                path="/app/client-portal/tool-archive"
                element={
                  <RouteGuard allowedRoles={['client', 'admin']}>
                    <ClientPortalToolArchive />
                  </RouteGuard>
                }
              />
              <Route

...
import { Shield, Target, ClipboardList, LogOut, ChevronRight, GraduationCap, TrendingUp, User, Users, HelpCircle, Globe, Crown, Wallet, PiggyBank, Landmark, Gift, Settings, FileBarChart, Camera, Archive, CalendarDays, CheckSquare, Scroll } from 'lucide-react';
import {
  Sheet,
  SheetContent,
  SheetHeader,
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="rounded-t-3xl max-h-[85vh] overflow-y-auto touch-pan-y" style={{ paddingBottom: 'calc(40px + env(safe-area-inset-bottom, 0px))', touchAction: 'pan-y' }}>
        ...
        <div className="space-y-1.5">
          ...
          <MoreLink to="/app/client-portal/manifest" icon={ScrollText} label="Mein Manifest" />
        </div>

...
export const KNOWLEDGE_CATEGORIES: KnowledgeCategory[] = [
  ...
  // ─── 2. Investieren & ETFs ───
  {
    ...
    articles: [
      ...
      },
      {
        id: 'humankapital',
        categoryId: 'investieren-etfs',
        title: 'Dein Humankapital: Dein grösstes Vermögen',
        shortDescription: 'Humankapital ist der Barwert all deiner zukünftigen Arbeitseinkommen – für die meisten Menschen das mit Abstand grösste «Vermögen», das sie je besitzen werden. Eine 30-jährige Person mit CHF 90\'000 Jahreslohn hat ein Humankapital von oft über CHF 2\'000\'000 – ein Vielfaches ihres Bankkontos.',
        whyImportant: 'Wer nur auf das Bankkonto schaut, übersieht 80–95 % seines tatsächlichen Vermögens. Humankapital schrumpft zudem jedes Jahr: jedes gearbeitete Jahr ist ein Jahr weniger zukünftiges Einkommen. Gleichzeitig wandelst du es kontinuierlich in Finanzkapital (Sparen, PK, 3a) um. Das macht Berufswahl, Weiterbildung und Lohnverhandlungen zu den wirkungsvollsten finanziellen Hebeln deines Lebens.',
        practiceExample: 'Sara (30) verdient CHF 90\'000 brutto und arbeitet noch 35 Jahre. Bei 1.5 % realer Lohnsteigerung und 3 % Diskontsatz ergibt das ein Humankapital von ca. CHF 2.4 Mio. Eine Weiterbildung für CHF 12\'000 (CAS), die ihren Lohn dauerhaft um 8 % steigert, generiert über 35 Jahre einen Mehrwert von über CHF 250\'000 – ein ROI von 2\'000 %. Vergleich: dieselben CHF 12\'000 in einen ETF mit 6 % Rendite ergeben nach 35 Jahren CHF 92\'000.',
        visualization: 'Zwei Kurven über Lebenszeit: Humankapital (sinkt mit Alter) vs. Finanzkapital (steigt). Schnittpunkt ca. mit 60 – ab dann lebst du vom umgewandelten Kapital.',
        commonMistakes: [
          'Humankapital ignorieren – nur auf Sparbetrag und Vermögen schauen',
          'Weiterbildungen als «Kosten» statt als Investment mit Renditeerwartung sehen',
          'Lohnverhandlungen vermeiden – jeder verpasste Lohnsprung wirkt 30+ Jahre',
          'Bei Berufswahl nur kurzfristiges Gehalt betrachten, nicht Lohnentwicklung über Karriere',
          'Erwerbsunfähigkeitsrisiko unterschätzen – ohne Versicherung verschwindet das Humankapital plötzlich',
        ],
        customerRelevance: 'Kennst du den ungefähren Wert deines Humankapitals? Genau das berechnet das Humankapital-Tool – und zeigt dir, wie viel jede Lohnerhöhung und Weiterbildung wirklich wert ist.',
        linkedToolKey: 'humankapital',
        linkedToolLabel: 'Humankapital berechnen',
        sources: [
          { title: 'BFS – Lohnstrukturerhebung', url: 'https://www.bfs.admin.ch' },
          { title: 'admin.ch – Weiterbildung', url: 'https://www.ch.ch/de/weiterbildung/' },
        ],
        readingMinutes: 6,
        xpReward: 30,
        addedAt: '2026-04-17',
  ...
  // ─── 3. Versicherungen ───
  {
    ...
    articles: [
      ...
      {
        id: 'vorsorgeauftrag-patientenverfuegung',
        categoryId: 'versicherungen',
        title: 'Vorsorgeauftrag & Patientenverfügung',
        shortDescription: 'Mit einem Vorsorgeauftrag bestimmst du selbst, wer im Falle einer Urteilsunfähigkeit (Unfall, Demenz, Koma) deine persönlichen, finanziellen und rechtlichen Angelegenheiten regelt. Mit der Patientenverfügung legst du fest, welche medizinischen Massnahmen du (nicht) wünschst. Beide Dokumente sind seit 2013 im Erwachsenenschutzrecht (Art. 360 ZGB) verankert – und werden trotzdem von über 70 % der Schweizer:innen vernachlässigt.',
        whyImportant: 'Ohne Vorsorgeauftrag entscheidet im Ernstfall die KESB (Kindes- und Erwachsenenschutzbehörde) – ein behördlich eingesetzter Beistand verwaltet dein Geld, deine Wohnung, deine Verträge. Selbst Ehepartner haben ohne Vorsorgeauftrag nur sehr eingeschränkte Rechte. Die emotionale und finanzielle Belastung für deine Familie ist enorm. Dasselbe gilt für medizinische Entscheidungen ohne Patientenverfügung – Angehörige müssen schwierige Entscheidungen treffen, ohne deinen Willen zu kennen.',
        practiceExample: 'Markus (52) erleidet einen Schlaganfall und ist urteilsunfähig. Ohne Vorsorgeauftrag: Seine Frau Anna kann nicht auf die Geschäftskonten zugreifen, kann den Hausverkauf nicht regeln, braucht für jede grössere Entscheidung KESB-Genehmigung – Verfahren dauern Monate, kosten mehrere Tausend Franken. Mit Vorsorgeauftrag: Anna ist sofort handlungsfähig, alle Massnahmen sind im Sinne von Markus geregelt, keine Behörde involviert.',
        visualization: 'Entscheidungsbaum: «Bist du urteilsunfähig?» → mit Vorsorgeauftrag = Ehepartner/Vertrauensperson handelt sofort / ohne = KESB ernennt Beistand (Wartezeit 3–12 Monate, Kosten CHF 2\'000–5\'000+).',
        commonMistakes: [
          'Annehmen, der Ehepartner sei automatisch bevollmächtigt (er ist es nur sehr eingeschränkt)',
          'Dokument zwar erstellen, aber niemandem mitteilen, wo es liegt – im Ernstfall nicht auffindbar',
          'Vorsorgeauftrag ohne notarielle Beurkundung oder eigenhändige Form (formell ungültig)',
          'Patientenverfügung nicht regelmässig (alle 2 Jahre) aktualisieren und neu unterschreiben',
          'Glauben, Vorsorgeauftrag sei nur für ältere Menschen – Unfälle treffen jedes Alter',
          'Beide Dokumente verwechseln: Vorsorgeauftrag = wer entscheidet / Patientenverfügung = was medizinisch erlaubt ist',
        ],
        customerRelevance: 'Hast du einen Vorsorgeauftrag und eine Patientenverfügung – und weiss deine Familie, wo sie liegen? Falls nein: Das ist eine 2-Stunden-Aufgabe mit lebenslanger Wirkung.',
        sources: [
          { title: 'admin.ch – Vorsorgeauftrag', url: 'https://www.ch.ch/de/vorsorgeauftrag/' },
          { title: 'admin.ch – Patientenverfügung', url: 'https://www.ch.ch/de/patientenverfuegung/' },
          { title: 'FMH – Patientenverfügung Vorlage', url: 'https://www.fmh.ch/dienstleistungen/recht/patientenverfuegung.cfm' },
          { title: 'Pro Senectute – Vorlage Vorsorgeauftrag', url: 'https://www.prosenectute.ch' },
        ],
        readingMinutes: 6,
        xpReward: 30,
        addedAt: '2026-04-17',
  ...
  // ─── 4. Budgeting & Sparen ───
  {
    ...
    articles: [
      ...
      },
      {
        id: 'konten-modell',
        categoryId: 'budgeting-sparen',
        title: 'Das Konten-Modell: Geld richtig aufteilen',
        shortDescription: 'Das Konten-Modell verteilt dein Einkommen automatisch auf 4–5 spezialisierte Konten: Fixkosten, Variable Ausgaben, Notgroschen, Sparen/Investieren und (optional) Spass-Konto. So entsteht Klarheit ohne tägliche Disziplin – jedes Konto hat einen Zweck, und das Geld fliesst automatisch dorthin, wo es hingehört.',
        whyImportant: 'Ein einziges Konto für alles ist der häufigste Grund, warum Menschen am Monatsende «nicht wissen, wo das Geld geblieben ist». Mit dem Konten-Modell brauchst du keine App und kein tägliches Tracking – du siehst auf einen Blick, ob ein Topf noch gefüllt ist. Es ist das einfachste Geldsystem mit der höchsten Wirkung im Alltag.',
        practiceExample: 'Mia (CHF 6\'000 netto pro Monat) richtet das System ein: 1) Fixkosten-Konto: CHF 3\'000 (Miete CHF 1\'700, KK CHF 380, Versicherungen CHF 200, Abos CHF 120, Strom/Internet CHF 250, Mobilität CHF 350) – Daueraufträge laufen automatisch ab. 2) Variable-Ausgaben-Konto + Karte: CHF 1\'200 (Lebensmittel, Restaurant, Drogerie). 3) Spass-Konto: CHF 400 (Hobby, Shopping, schuldfreies Vergnügen). 4) Notgroschen-Konto bei anderer Bank: CHF 200 → Ziel CHF 14\'000. 5) Investment-Konto: CHF 1\'200 → davon CHF 605 in 3a, CHF 595 in ETF-Sparplan. Alles per Dauerauftrag am 25. (Lohntag).',
        visualization: 'Visuelles Schema: 1 Lohnkonto → 4 Pfeile zu Fixkosten / Variabel / Notgroschen / Investieren. Pro Topf eine prozentuale Faustregel + CHF-Beispiel.',
        commonMistakes: [
          'Alle Konten bei derselben Bank – verleitet zum Verschieben zwischen den Töpfen',
          'Zu viele Konten (8+) – Komplexität tötet das System',
          'Sparen aus dem «Rest» nehmen statt am Monatsanfang fix abzuziehen (Pay-Yourself-First)',
          'Notgroschen mit Investment-Konto vermischen – beide haben unterschiedliche Zwecke',
          'Daueraufträge nicht automatisieren – manuelle Disziplin scheitert nach wenigen Monaten',
          'Spass-Konto weglassen – dann fühlt sich Sparen wie Verzicht an statt wie System',
        ],
        customerRelevance: 'Hast du ein bewusstes Konten-System – oder fliesst alles über ein Konto? Das Konten-Modell-Tool zeigt dir in 10 Minuten deine ideale Aufteilung.',
        linkedToolKey: 'konten-modell',
        linkedToolLabel: 'Konten-Modell starten',
        sources: [
          { title: 'budgetberatung.ch – Schweizer Budgetplattform', url: 'https://www.budgetberatung.ch' },
          { title: 'admin.ch – Persönliches Budget', url: 'https://www.ch.ch/de/budget/' },
        ],
        readingMinutes: 6,
        xpReward: 30,
      ...
      },
      {
        ...
        categoryId: 'budgeting-sparen',
        title: 'Finanzielle Freiheit: Was ist das wirklich?',
        shortDescription: 'Finanzielle Freiheit bedeutet, dass deine passiven Einkommen (aus Investments, Mieten, Renten) deine monatlichen Ausgaben dauerhaft übersteigen – du bist nicht mehr auf Erwerbsarbeit angewiesen. Der PeakScore in dieser App misst genau das: wie viele Monate du heute ohne Einkommen leben könntest. Ein PeakScore von 12 = 12 Monate Freiheit.',
        whyImportant: 'Finanzielle Freiheit ist nicht nur «Reich werden mit 40» – sie ist primär ein Sicherheitsnetz, das dir Wahlfreiheit gibt: den Job zu wechseln, eine Auszeit zu nehmen, Kinder zu bekommen oder einfach besser zu schlafen. Wer früh anfängt, profitiert exponentiell vom Zinseszins – jedes Jahr Aufschub kostet später überproportional viel.',
        practiceExample: 'Lisa (30) hat monatliche Ausgaben von CHF 4\'000 und will mit 50 finanziell frei sein (FIRE). Faustregel «Trinity Rule» 4 %-Entnahmerate: nötiges Vermögen = 4\'000 × 12 / 0.04 = CHF 1.2 Mio. Bei 6 % realer Rendite + CHF 2\'500 monatlicher Sparrate erreicht sie das in genau 20 Jahren. Hätte sie erst mit 35 begonnen, müsste sie für dasselbe Ziel CHF 4\'200/Monat sparen – 68 % mehr! Schweiz-Spezifika: Säule 3a + PK können erst ab 60/65 bezogen werden, daher braucht es zusätzlich einen «Brückenfonds» in einem freien Depot bis Pensionierung.',
        visualization: 'PeakScore-Skala: 1 Monat (rot) → 6 Monate (gelb) → 12 Monate (grün) → 36 Monate (blau «freiheitsnah») → 12×Restlebenserwartung (volle finanzielle Freiheit). Plus Vermögenskurve mit Start-Alter 25/30/35/40.',
        commonMistakes: [
          'Finanzielle Freiheit nur als «nie mehr arbeiten» verstehen – sie ist primär Wahlfreiheit',
          'Schweizer Spezifika ignorieren: PK/3a sind bis 60+ gebunden, brauchen Brückenkapital',
          'Inflation in der Berechnung vergessen – CHF 1 Mio. heute ≠ CHF 1 Mio. in 30 Jahren',
          'Mit zu hohen Erwartungen rechnen (8–10 % Rendite) – realistisch sind 4–6 % netto, real',
          'Erst mit hohem Einkommen starten wollen – Sparquote schlägt Gehalt langfristig immer',
          'Ausgaben nie reduzieren: Jeder Franken weniger Ausgaben senkt das Zielvermögen um CHF 300 (4 %-Regel)',
        ],
        customerRelevance: 'Wie hoch ist dein heutiger PeakScore – und wie weit bist du vom Ziel «12 Monate Freiheit» entfernt? Die App zeigt dir bei jedem Snapshot deinen aktuellen Stand.',
        linkedToolKey: 'mein-finanzplan',
        linkedToolLabel: 'Finanzplan öffnen',
        sources: [
          { title: 'Trinity Study – 4 %-Entnahmeregel', url: 'https://en.wikipedia.org/wiki/Trinity_study' },
          { title: 'BSV – Frühpensionierung', url: 'https://www.bsv.admin.ch' },
          { title: 'admin.ch – Pensionierungsplanung', url: 'https://www.ch.ch/de/altersvorsorge/' },
        ],
        readingMinutes: 7,
        xpReward: 30,
        addedAt: '2026-04-17',
  ...
  // ─── 6. Steuern Schweiz ───
  {
    ...
    articles: [
      ...
      {
        id: 'auswandern-finanz-check',
        categoryId: 'steuern-schweiz',
        title: 'Auswandern aus der Schweiz: Finanz-Check',
        shortDescription: 'Wer die Schweiz verlässt, löst eine Kette finanzieller Konsequenzen aus: 3a kann je nach Zielland steuergünstig bezogen werden, die PK wird teilweise oder ganz ausgezahlt, AHV-Beiträge stoppen (Lücken entstehen), die Krankenkasse erlischt mit dem Wegzug, und je nach Land werden Schweizer Vorsorgegelder doppelt besteuert oder gar nicht anerkannt. Ein detaillierter Finanz-Check 6–12 Monate vor dem Wegzug ist Pflicht.',
        whyImportant: 'Falsch geplante Emigration kann sechsstellige Beträge kosten: doppelte Besteuerung von 3a/PK, verfallene AHV-Anwartschaften, fehlende Krankenversicherung im neuen Land. Umgekehrt lassen sich mit der richtigen Reihenfolge (z. B. PK-Bezug nach Wegzug nach Zypern oder Portugal) zehntausende Franken Steuern legal sparen. Die Komplexität steigt mit jedem zusätzlichen Land, Doppelbesteuerungsabkommen und Aufenthaltsdauer.',
        practiceExample: 'Tom (45) zieht von Zürich nach Lissabon. Sein PK-Guthaben: CHF 320\'000. Bei Bezug in der Schweiz: ca. CHF 18\'000 Kapitalbezugssteuer ZH. Wegzug in EU/EFTA-Land mit Erwerbstätigkeit → nur überobligatorischer Teil sofort beziehbar. Wegzug ausserhalb EU/EFTA (z. B. USA, UK) → vollständiger Bezug möglich, Steuern fallen am Sitz der Vorsorgeeinrichtung an (oft Schwyz mit ca. 4–5 % statt ZH 7–8 %). 3a: vollständiger Bezug möglich, ebenfalls am Sitz der Stiftung versteuert. AHV: freiwillige Weiterversicherung nur bei Wohnsitz ausserhalb EU/EFTA möglich, kostet CHF 950–25\'000/Jahr. KK: Schweizer Grundversicherung erlischt zwingend zum Abreisedatum.',
        visualization: 'Checkliste-Timeline: 12 Monate vor Wegzug (Steuerberatung & Doppelbesteuerungsabkommen prüfen) → 6 Monate (PK/3a-Strategie festlegen, Sitzkanton der Stiftung beachten) → 3 Monate (KK kündigen, AHV-Status klären) → Tag 0 (Abmeldung Gemeinde, Steuerveranlagung).',
        commonMistakes: [
          'PK in der Schweiz beziehen statt nach Wegzug – Steuerersparnis durch günstigere Sitzkantone wird verpasst',
          'Vergessen, dass nur überobligatorischer Teil bei Wegzug in EU/EFTA mit Erwerbstätigkeit sofort beziehbar ist',
          'AHV-Beitragslücken durch Auslandsjahre ignorieren – führt später zu gekürzter Rente',
          'Krankenkasse vergessen zu kündigen – läuft sonst weiter und verursacht Kosten',
          'Doppelbesteuerungsabkommen nicht prüfen – Vorsorgegelder können in beiden Ländern besteuert werden',
          'Wegzugsteuer auf nicht realisierte Wertzuwächse vergessen (relevant bei Aktienpaketen)',
          'Annahme, das Zielland akzeptiere Schweizer 3a-/PK-Bezüge automatisch steuerfrei',
        ],
        customerRelevance: 'Spielst du mit dem Gedanken auszuwandern – temporär oder dauerhaft? Das Expat-Tool simuliert die finanziellen Konsequenzen für 8 beliebte Zielländer.',
        linkedToolKey: 'expat-szenarien',
        linkedToolLabel: 'Expat-Szenarien öffnen',
        sources: [
          { title: 'admin.ch – Auswandern', url: 'https://www.ch.ch/de/auswandern/' },
          { title: 'EDA – SwissCommunity', url: 'https://www.swisscommunity.org' },
          { title: 'BSV – AHV im Ausland', url: 'https://www.bsv.admin.ch/bsv/de/home/sozialversicherungen/ahv/grundlagen-gesetze/internationales.html' },
          { title: 'ESTV – Doppelbesteuerungsabkommen', url: 'https://www.estv.admin.ch/estv/de/home/internationales-steuerrecht/fachinformationen/dba.html' },
        ],
        readingMinutes: 7,
        xpReward: 30,
        addedAt: '2026-04-17',

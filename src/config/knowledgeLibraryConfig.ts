...
export const KNOWLEDGE_CATEGORIES: KnowledgeCategory[] = [
    ...
    articles: [
      {
        ...
        shortDescription: 'Die Schweizer Vorsorge basiert auf drei Säulen: staatliche AHV, berufliche Vorsorge und private Vorsorge. Zusammen bilden sie dein finanzielles Sicherheitsnetz.',
        ...
        customerRelevance: 'Verstehst du, wie dein Einkommen im Alter zusammengesetzt sein wird? Gemeinsam schauen wir, wo du heute aktiv werden kannst.',
        sources: [
      ...
      },
      {
        ...
        shortDescription: 'Die Differenz zwischen deinem letzten Lohn und der tatsächlichen Rente kann erheblich sein. Diese Lücke frühzeitig zu kennen, ist entscheidend.',
        ...
        customerRelevance: 'Weisst du, wie viel dir im Alter tatsächlich fehlen wird? Gemeinsam berechnen wir deine persönliche Lücke.',
      ...
      },
      {
        ...
        shortDescription: 'Die AHV ist die Basisrente der Schweiz. Die maximale Einzelrente beträgt CHF 2\'450/Monat – egal, wie viel du verdient hast.',
        ...
        customerRelevance: 'Kennst du deine voraussichtliche AHV-Rente? Das ist der erste Schritt zu einer realistischen Finanzplanung.',
      },
    ],
  },
    ...
    articles: [
      {
        ...
        shortDescription: 'Einzahlungen in die Säule 3a kannst du vollständig vom steuerbaren Einkommen abziehen. Das spart je nach Kanton mehrere tausend Franken pro Jahr.',
        ...
        customerRelevance: 'Nutzt du den Steuervorteil bereits voll aus? Jedes Jahr ohne Einzahlung ist ein verlorener Steuervorteil.',
      ...
      },
      {
        ...
        customerRelevance: 'Weisst du, was deine aktuelle 3a-Lösung kostet – und ob es bessere Alternativen gibt?',
    ...
    articles: [
      {
        ...
        shortDescription: 'Rendite ist der Gewinn, den dein investiertes Geld über die Zeit erwirtschaftet – ausgedrückt in Prozent pro Jahr.',
        whyImportant: 'Ohne Rendite verliert dein Geld durch Inflation an Wert. Schon kleine Unterschiede haben über Jahrzehnte eine massive Wirkung.',
        ...
        customerRelevance: 'Verstehst du, wie dein Geld für dich arbeiten kann? Der Unterschied zwischen Sparen und Investieren ist grösser, als du denkst.',
      ...
      },
      {
        ...
        shortDescription: 'Ein ETF (Exchange Traded Fund) bildet einen Index wie den SMI oder MSCI World ab. So investierst du breit gestreut und kostengünstig.',
        ...
        customerRelevance: 'ETFs können ein einfacher Einstieg in die Welt des Investierens sein. Wir zeigen dir, worauf es ankommt.',
        linkedToolKey: 'rendite-risiko',
      ...
      },
      {
        ...
        shortDescription: 'Der Zinseszins ist das mächtigste Werkzeug beim Investieren. Er sorgt dafür, dass dein Geld exponentiell wächst – je länger, desto stärker.',
        ...
        customerRelevance: 'Je früher du startest, desto mehr arbeitet die Zeit für dich. Selbst kleine Beträge machen langfristig einen grossen Unterschied.',
      },
    ],
  },
    ...
    articles: [
      {
        ...
        customerRelevance: 'Verstehst du den Unterschied zwischen kurzfristiger Schwankung und echtem Risiko? Das hilft dir, bessere Entscheidungen zu treffen.',
        linkedToolKey: 'rendite-risiko',
      ...
      },
      {
        ...
        customerRelevance: 'Der beste Zeitpunkt zu investieren war gestern. Der zweitbeste ist heute. Wir helfen dir, einen guten Rhythmus zu finden.',
      },
      {
        id: 'inflation-risiko',
        categoryId: 'risiken-fehler-mythen',
        title: 'Das unsichtbare Risiko: Inflation',
        shortDescription: 'Dein Geld auf dem Sparkonto verliert jedes Jahr an Kaufkraft. Bei 2% Inflation sind CHF 100\'000 in 20 Jahren nur noch CHF 67\'000 wert.',
        ...
        customerRelevance: 'Auch Nichtstun hat Kosten. Eine kluge Strategie schützt dein Geld besser als ein Sparkonto.',
      },
    ],
  },
  ...
  // ─── 5. Strategien & Umsetzung ───
  {
    ...
    description: 'Konkrete Wege für deinen Vermögensaufbau',
    icon: 'Map',
    color: 'scale-7',
    articles: [
      {
        ...
        shortDescription: 'Ein Sparplan investiert automatisch jeden Monat einen festen Betrag. So kaufst du manchmal günstig und manchmal teuer – im Schnitt profitierst du.',
      ...
      },
      {
        ...
        shortDescription: 'Verteile dein Geld auf verschiedene Anlageklassen, Regionen und Branchen. So reduzierst du das Risiko, ohne auf Rendite zu verzichten.',
        ...
        customerRelevance: 'Eine gute Streuung ist die Grundlage jeder soliden Anlagestrategie. Wir bauen dein Portfolio so auf, dass es zu dir passt.',
      },
      {
        id: 'rebalancing',
        categoryId: 'strategien-umsetzung',
        title: 'Rebalancing – Dein Portfolio in Balance halten',
        shortDescription: 'Durch Kursschwankungen verschiebt sich die Gewichtung deines Portfolios. Regelmässiges Rebalancing stellt die ursprüngliche Aufteilung wieder her.',
        whyImportant: 'Ohne Rebalancing wird dein Portfolio unbemerkt risikoreicher. Regelmässiges Anpassen hält die Strategie auf Kurs.',
        ...
        customerRelevance: 'Wir kümmern uns darum, dass dein Portfolio immer in der richtigen Balance bleibt – automatisch und regelmässig.',
      },
    ],
  },
    ...
    articles: [
      {
        ...
        customerRelevance: 'Erkennst du dich wieder? Viele junge Familien stehen vor ähnlichen Fragen. Wir haben passende Lösungen.',
      },
      {
      ...
      },
      {
        ...
        customerRelevance: 'Hast du auch den Wunsch, früher aufzuhören? Wir zeigen dir, ob und wie das möglich ist.',
      },
    ],
  },
    ...
    articles: [
      {
        ...
        whyImportant: 'Sicherheit ist ein Grundbedürfnis. Wer es ernst nimmt und erklärt, baut Vertrauen auf.',
        ...
        customerRelevance: 'Dein Geld ist gut aufgehoben – wenn die Strategie stimmt. Wir sorgen dafür, dass du ruhig schlafen kannst.',
      },
      {
        id: 'faq-kosten',
        categoryId: 'faq-einwaende',
        ...
        customerRelevance: 'Gute Beratung ist eine Investition. Wir zeigen dir transparent, was du bekommst – und was es kostet.',
      },
      {
        id: 'faq-zu-spaet',
        categoryId: 'faq-einwaende',
        title: '«Bin ich nicht zu alt, um noch etwas zu ändern?»',
        shortDescription: 'Es ist nie zu spät. Auch mit 50+ gibt es wirkungsvolle Massnahmen, die deine Vorsorge und Steuersituation deutlich verbessern.',
        ...
        customerRelevance: 'Auch mit 50+ kannst du noch viel bewegen. Wir zeigen dir, welche Hebel jetzt die grösste Wirkung haben.',
      },
    ],
  },
    ...
    articles: [
      {
        ...
        customerRelevance: 'Du kannst darauf vertrauen, dass unsere Empfehlungen auf soliden, überprüfbaren Grundlagen basieren.',
        sources: [
      ...
      },
      {
        ...
        shortDescription: 'Wir sind nicht an einen bestimmten Anbieter gebunden. Unsere Empfehlungen basieren auf deinen Bedürfnissen – nicht auf Provisionen.',
        whyImportant: 'Unabhängige Beratung ist die Grundlage für objektive Empfehlungen. Du sollst wissen, dass wir in deinem Interesse handeln.',
        practiceExample: 'Wir vergleichen Angebote von über 15 verschiedenen Anbietern und wählen die beste Lösung für deine Situation.',
        ...
        customerRelevance: 'Bei uns steht dein Interesse im Zentrum. Wir verkaufen keine Produkte – wir finden die beste Lösung für dich.',
      },
      {
        id: 'haftungshinweis',
        categoryId: 'quellen-transparenz',
        ...
        whyImportant: 'Rechtliche Klarheit schützt beide Seiten – dich und uns.',
        ...
        customerRelevance: 'Diese Bibliothek gibt dir Orientierung. Für deine persönliche Strategie empfehlen wir ein individuelles Gespräch.',
      },
    ],
  },
];

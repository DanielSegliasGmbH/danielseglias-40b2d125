  ...
  services: [
    {
      icon: Eye,
      title: 'Transparenz',
      description: 'Uneingeschränkte Transparenz in allen Beratungsprozessen. Sie wissen immer genau, wofür Sie bezahlen.',
    },
    {
      icon: Coins,
      title: 'Kostenoptimierung',
      description: 'Wir handeln perfekt kostenoptimiert – immer in Ihrem Interesse, nie im Interesse von Provisionen.',
    },
    {
      icon: Users,
      title: 'Kundenorientierung',
      description: 'Ihre Bedürfnisse stehen im Mittelpunkt. Wir entwickeln massgeschneiderte Lösungen für Ihre Situation.',
    },
  ],
};
